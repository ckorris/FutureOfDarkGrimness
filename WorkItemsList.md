...
Corpus coverage is a different story: 243 of 13,870 book rule references (1.8%) do nothing today — see #197 (#196, the data-only half, closed 2026-07-22).
...
- [~] 264 — Server browser: $0-tier master list server (Cloudflare Worker registry, TTL heartbeats) + "List publicly" host checkbox + browser-first join UI. P1-P3 + deploy + UPnP auto-forward done 2026-07-23; remaining: lobby status surface, GUI hand-verify, live 2-machine + real-router UPnP test. ([WorkItems/264](WorkItems/264-server-browser.md))
