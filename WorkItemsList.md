...
- [~] 275 — Banner tiers: one always-blocking `BannerBeat` split into Headline/Notice/Toast (own sizes, sounds, screen bands); the two lower tiers ride a concurrent track so they never halt play, and all 28 announce sites were re-tiered (4/15/9). Implemented + tested; awaiting GUI hand-verify. ([WorkItems/275](WorkItems/275-banner-tiers.md))
