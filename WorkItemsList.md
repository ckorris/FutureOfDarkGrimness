...
- [~] 277 — Networked decision previews: stream a deciding player's live resolver state (ghosts, planned paths) to all players via a payload-agnostic preview channel; engine transport done (slice 1), app publisher/overlay + movement payload next. ([WorkItems/277](WorkItems/277-networked-decision-previews.md))
