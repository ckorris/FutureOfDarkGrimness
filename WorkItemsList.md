...
- [~] 244 — Dice roll panel redesign: bottom-docked caption strip + standalone "4+" target badge, ghost-fade when the attack animation overlaps, stable width, throttled tumble, fade in/out; v2 moved roll-offs to the strip too + restacked the bottom-left toolbar vertical. Implemented + tested; awaiting GUI hand-verify. ([WorkItems/244](WorkItems/244-dice-caption-strip.md))
