...
- [~] 274 — Spell cast visuals + sounds: `SpellEffectBeat` with six variants (cast success/failure on the caster, per-target boon/bane, assist boost/hinder), `SpellOverlay`, six synthesized cues. Implemented + tested; awaiting GUI hand-verify. ([WorkItems/274](WorkItems/274-spell-cast-visuals.md))
