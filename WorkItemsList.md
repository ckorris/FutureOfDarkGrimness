...
- [~] 277 — Networked decision previews: stream a deciding player's live resolver state (ghosts, planned paths) to all players via a payload-agnostic preview channel; movement hand-verified live, consolidation/aircraft/place-objects opted in (awaiting hand-verify); objective+terrain markers still to do. ([WorkItems/277](WorkItems/277-networked-decision-previews.md))
