...
- [ ] 183 — **(HIGH PRIORITY — design fork, plan written 2026-07-08, awaiting sign-off)** Hero-join Subject-seat rule attribution: hero-carried defensive rules silently vanish post-join; host-carried ones over-apply. Options A/B/C + recommendation (gate-centric C) in [Notes](WorkItems/183-hero-subject-seat-attribution.md). Audit §8.17; relates #093/#006.
