...
- [~] 323 — Pre-roll shooting forecast: effective Hit/Save + beat-identical modifier tags computed read-only engine-side, on target rows / details pane / canvas hover badge. Implemented + tested; awaiting GUI hand-verify. ([WorkItems/323](WorkItems/323-shooting-forecast-ui.md))
