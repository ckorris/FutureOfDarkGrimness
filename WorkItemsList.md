...
- [ ] 389 — Walled-in rear shooter (WarriorSistersMovedLaterally save) activates on a PHANTOM kill urgency (straight-line advance the friendly wall forbids; frontline bias swamped 1.00-vs-0.11), then the clipped forward stubs lose to a lateral Escort slide that dodges the threat premium. Investigation complete with per-term decompositions; fix candidates await Chris's pick. ([WorkItems/389](WorkItems/389-rear-shooter-phantom-urgency-lateral-slide.md))
