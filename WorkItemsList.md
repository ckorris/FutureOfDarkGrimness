...
- [~] 247 — Range/threat overlay UI: slice 1 built 2026-07-26 — `FieldAnchorPlan` collapses the anchor decision to one contest (hover > ghosts > pin, exactly one field on screen), hover anchors on any unit, `V` is the global toggle, hover rebuilds signature-cached. Q5 (threat frontiers) + legend still open; awaiting GUI hand-verify. ([WorkItems/247](WorkItems/247-range-overlay-ui.md))
