...
- [~] 329 — In-game Army List overlay: L toggles a fullscreen modal of every player's list (tabs), card + condensed table modes, live wounds/points/activation + hoverable rules; labels rebound to N; points + army identity plumbed engine-side. Slices 1-3 implemented + tested 2026-08-02; awaiting GUI hand-verify (checklist in detail file). ([WorkItems/329](WorkItems/329-army-list-overlay.md))
