...
- [~] 219 — Bundled `.fdgbook` upgrades imported as free. 2026-07-22: premise overturned - prices ARE published in per-unit `costs[]`; importer reads them + `--import-book` re-priced the catalog (47/47, 3467 real prices) + verbatim share-import now attributes per-unit (HEF Noble imports as 120/0-unattributed, matching Army Forge). All code done; awaiting GUI hand-verify. ([WorkItems/219](WorkItems/219-army-forge-zero-cost-upgrades.md))
