...
- [~] 299 — "Alternating: Points" terrain mode: pieces cost 1-3 points, each turn spends a per-turn allowance from a pre-dealt personal total (20/3 two players = 11/9), first-piece debt allowed but never while repaying; old mode relabeled "Alternating: One Per". Implemented + tested; awaiting GUI hand-verify. ([WorkItems/299](WorkItems/299-alternating-points-terrain.md))
