...
- [~] 256 — AI multi-model units barely move (WayTooManyInBack stuck bots, solo + Tactician alike). S1 (measure-and-correct budgets) + S2 (re-aim vs halve on friendly stacking) + S4 (on-path snake through narrow corridors) landed 2026-07-22, verified on the real save (pocket drains rounds 3-4); S3 refuted by evidence. Residual: #191 D1 benchmark rerun + Chris GUI session. ([WorkItems/256](WorkItems/256-ai-repack-clamp-immobilizes-big-units.md))
