...
- [ ] 262 — Army Forge charges a "Replace X" whose target the unit doesn't carry; we apply and charge nothing (80 pts of the reported list). Three-way fork on which behavior is right needs a ruling. ([WorkItems/262](WorkItems/262-replace-target-absent-charged-by-opr.md))
