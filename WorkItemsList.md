...
- [~] 329 — In-game Army List overlay: L toggles a fullscreen modal of every player's list (tabs) in the Army Forge card style, live wounds/casualties/activation + hoverable rules; labels rebound to N. Slice 1 implemented + tested 2026-08-02; awaiting GUI hand-verify; slices 2 (engine points plumb) + 3 (table mode) open. ([WorkItems/329](WorkItems/329-army-list-overlay.md))
