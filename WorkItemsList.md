...
- [~] 197 — Faction rule coverage pt.2: dead rule names needing new engine primitives. Corpus dead refs 2,342 -> 121 (24 names); slice 0, P5a/P5b, P6, P10, P11, P13, P14b, P17, P21, P22, P23, Teleport, Delayed Action, Darkborn, P15, Dash, the reroll threshold and the Misc pass are all shipped. Open: Inquisitorial Agent, P8, Sergeant, P20, Strafing, Armor(X), P7, Extended Buff Range, P16, P19 and the tail. ([WorkItems/197](WorkItems/197-faction-rule-engine-primitives.md))

All 33 GF v3.5.1 core special rules are implemented (verified 2026-06-30; see archive #029-#032/#051).
Corpus coverage is a different story: 121 of 13,870 book rule references (0.9%) do nothing today — see #197 (#196, the data-only half, closed 2026-07-22). The 2026-07-28 passes shipped P22 (all 5 Ambush variants, 199 -> 157), P17 (all 4 place/restore rules, 157 -> 133) Dash (133 -> 127) and the Mischievous/Scrapper Boost reroll threshold (127 -> 121); still open: Instinctive, Inquisitorial Agent, Extended Buff Range, and the long tail (P8, P20, P7, P16, P19, Strafing).
