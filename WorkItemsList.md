...
- [ ] 239 — Weapon effect sets: 13 ranged / 10 melee themed visual+sound styles baked into books/armies as explicit keys (faction defaults + global fallback), truthful hit/miss impacts + impact sounds. Plan signed off; not started. ([WorkItems/239](WorkItems/239-weapon-effect-sets.md))
