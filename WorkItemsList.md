...
- [~] 309 — Accidental passes in the Choose Action menu (both players in a 2026-08-02 game): Pass is pulled out of the option list, pinned to the bottom of the panel below Back with padding above and below, and asks for confirmation (Enter/Space passes, Esc cancels). Implemented + tested; awaiting GUI hand-verify. ([WorkItems/309](WorkItems/309-pass-confirmation.md))
