...
- [ ] 197 — Faction rule coverage pt.2: the 97 dead names (942 refs) needing new engine primitives. DONE so far: slice 0 (scope mismatch, 145 refs) and the ">9in shot or charged" gate (`attackedFromOverInches`, +10 refs), which also fixed three defect classes in #196's shipped data. ([WorkItems/197](WorkItems/197-faction-rule-engine-primitives.md))

All 33 GF v3.5.1 core special rules are implemented (verified 2026-06-30; see archive #029-#032/#051).
Corpus coverage is a different story: 1,018 of 13,870 book rule references (7.3%) do nothing today — see #196/#197.
