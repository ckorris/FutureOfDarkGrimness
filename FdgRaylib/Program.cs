...
else
{
    ...
    renderer.LobbyScreen.OnGameLaunched = (tableState, colorFunc, log, overlay, taskDisplay, presentationPlayer) =>
        renderer.TransitionToGame(tableState, colorFunc, log, overlay, taskDisplay, presentationPlayer);
