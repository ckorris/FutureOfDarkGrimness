...
else
{
    ...
    renderer.LobbyScreen.OnGameLaunched = (tableState, colorFunc, log, overlay, taskDisplay, saveGame) =>
        renderer.TransitionToGame(tableState, colorFunc, log, overlay, taskDisplay, saveGame);
