...
/// <summary>
/// Resolves the base URL of the master list server (#271). Resolution order:
...
{
    // The deployed list-server Worker (#271), live 2026-07-23. Overridable at runtime via the
